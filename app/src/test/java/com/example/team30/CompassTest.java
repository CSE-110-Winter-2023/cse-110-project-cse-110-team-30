...
import org.junit.Test;
    ...
    public class CompassTest {
        ...
        public void calculateAngleWithDistanceTest(){
            ...
            assertEquals(84.332020791674,compass_test.calculateAngle("Parent", coordinates, ),0.01);
            assertEquals(109.27354652632,compass_test.calculateAngle("Friend", coordinates, ),0.01);
            assertEquals(224.92834135802,compass_test.calculateAngle("Home", coordinates, ),0.01);
        }
        @Test
...
//            compass_test.addLocation(locationHome);
            ...
            Coordinates coordinates = new Coordinates((float) 37.7749, (float) -122.4194);
            assertEquals(271.64285785969,compass_test.calculateAngle("Parent", coordinates, ),0.01);
            assertEquals(107.1486332690,compass_test.calculateAngle("Friend", coordinates, ),0.01);
